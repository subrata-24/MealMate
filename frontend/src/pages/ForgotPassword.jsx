        ...
        {step === 1 && (
          <div className="mb-4">
            ...
            <div className="flex justify-center mt-4">
              <button className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold py-3 px-39 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.03] transition-all duration-300 cursor-pointer">
                Send OTP
              </button>
            </div>
          </div>
